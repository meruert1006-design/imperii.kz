...
export default function PublicLayout() {
  ...
  const gisLink = 'https://2gis.kz/almaty/geo/70000001030722920';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-900 text-white shadow-lg transition hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-300"
          aria-label="Открыть в 2ГИС"
          title="Открыть в 2ГИС"
        >
          <span className="text-sm font-semibold">2ГИС</span>
        </a>
        <a
          href={whatsappLink}
          target="_blank"
          rel="noreferrer"
          className="flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300"
